...
NAME="Swapper" #Package/Extension Name

TYPE="Extension" #Specify (Package / Extension)

AUTHOR="Jaxparrow" #Your name as the Developer/Owner/Packer

VERSION="3.2" #Specify the Version of this package/extension

SHORTDESC="Create and Manage Swap RAM" #Provide a short description about this package/extension

C_EXTNAME="Swapper - Manage Swap" #For Specifing a custom name for your extension script ($NAME is used if not defined)
