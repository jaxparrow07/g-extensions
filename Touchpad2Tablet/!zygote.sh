...
NAME="Touchpad to Tablet" #Package/Extension Name
...
SHORTDESC="Use your touchpad as drawing tablet" #Provide a short description about this package/extension

C_EXTNAME="Touchpad2Tablet" #For Specifing a custom name for your extension script ($NAME is used if not defined)
